 ...
 *
 * This class was stolen from {@link https://github.com/alexo/wro4j/blob/1.4.x/wro4j-extensions/src/main/java/ro/isdc/wro/extensions/script/RhinoScriptBuilder.java}
 *
...
public class RhinoUtils {
  ...
  private static void encode(final StringBuilder s, final Object object, final boolean indent, final int depth) {
    ...
    if (object == null) {
      ...
      encodeArray(s, (NativeArray) object, depth);
  ...
  private static void encodeArray(final StringBuilder s, final NativeArray array, final int depth) {
    s.append('[');
